...
/**
 * Bounces straight into the Fitbit OAuth flow, or explains why it cannot. Rendered by the
 * /link/fitbit deep link; the normal "Connect Fitbit Account" buttons do the same thing.
 */

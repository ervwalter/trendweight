...
const Buttons = () => {
  ...
  return (
    <div className="flex flex-col-reverse gap-4 md:flex-row print:hidden">
      <ToggleGroup type="single" value={timeRange} onValueChange={(value) => setTimeRange(value as TimeRange)} aria-label="Time Range">
      ...
      <ToggleGroup type="single" value={mode} onValueChange={(value) => setMode(value as Mode)} aria-label="Mode">
